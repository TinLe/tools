...
class configFormIE {
    ...
    function configFormIE($form, $left, $right) {
        $this->form=$form;
        $this->left=$left;
        $this->right=$right;
    }
    ...
    function createJS($callBack1, $callBack2) {
        ...
        $str.=$this->aL("  } else {"); //selection from right side
...
//$str.=$this->aL("alert ('Result: '+result);"); //Debug method
        ...
        $str.=$this->aL("      } else {");
        $str.=$this->aL("           document.getElementById('".$this->form."rSelection').innerHTML=split[0];");
        $str.=$this->aL("           document.getElementById('".$this->form."aSelection').innerHTML=split[1];");
        $str.=$this->aL("      }");
        $str.=$this->aL("    } else {");
    ...
    function createFormTableCustom($info,$label_left,$label_right,$title) {
        ...
        $str.=$this->aL("<span id='".$this->form."rSelection'>");
        ...
        $str.=$this->aL("</td>");
        $str.=$this->aL("<td align=\"center\">");
        $str.=$this->aL("<span id='".$this->form."aSelection'>");
