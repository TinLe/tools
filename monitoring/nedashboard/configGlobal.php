...
<html>
    ...
    <body bgcolor="#c3c7d3">
     <?php
        ...
        $board = new boardDAO();
        $availabilityDAO = new boardDAOAvailable();
        $allBoards = array_merge($board->getBoards(),$availabilityDAO->getBoards());
        ...
        <form name="globalSettingsForm" action="./actions/action.globalSettings.php">
            ...
            <tr><td colspan="2"><font face="Verdana" size="3"><b>General settings:</b></font></td></tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="fMax" maxlength="2" style="width: 20px; padding: 1px;" value="<?php $globalSettings->getValue("DB_tachosInRow")?>"/> &nbsp;tachos per row</td>
                </tr>
                <tr>
                    <td>Set time interval for rotation:<br> (in seconds) </td>
                    <td><input type="text" name="fTime" maxlength="4" style="width: 40px; padding: 1px;" value="<?php $globalSettings->getValue("DB_diashowRefreshTime")?>"/> &nbsp;seconds</td>
                </tr>
                <tr><td height="12"></td></tr>
                <tr><td colspan="2"><font face="Verdana" size="3"><b>Availability board settings:</b></font></td></tr>
                <tr>
                    <td>Availability critical min boundary: </td>
                    <td><input type="text" name="fAvailability" maxlength="2" style="width: 20px; padding: 1px;" value="<?php $globalSettings->getValue("DB_availability")?>"/>&nbsp;%</td>
                </tr>
                <tr>
