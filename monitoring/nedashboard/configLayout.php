...
<html>
    <head>
        ...
        <style>
            ...
            .itemContainer {
            width: <?php echo $DB_tachosInRow*200+$DB_tachosInRow*4; ?>px;
            height: 5000px;
            float:none;
        }
        .itemContainer .item {
...
?>
    ...
    <body bgcolor="#c3c7d3">
        ...
        ?>
        <hr align="left" width="<?php echo $DB_tachosInRow * 200 + $DB_tachosInRow * 4 - 2 * 2;?>px">
        <table width="<?php echo $DB_tachosInRow * 200 + $DB_tachosInRow * 4 - 2 * 2;?>px" cellspacing="0" cellpadding="2">
            <tr>
            	<td align="left">
        ...
        <table width="<?php echo $DB_tachosInRow * 200 + $DB_tachosInRow * 4 - 2 * 2;?>">
        ...
        <form name="layoutForm" action="actions/action.layout.php">
            <input type="hidden" name="board" value="<?php echo $selectedBoard;?>" />
